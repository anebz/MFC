...
{
	CDialogEx::DoDataExchange(pDX);
	DDX_Slider(pDX, IDC_SLIDER1, sldr);
...
BEGIN_MESSAGE_MAP(CTankDlg, CDialogEx)
	...
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_NOTIFY(NM_CUSTOMDRAW, IDC_SLIDER1, &CTankDlg::OnNMCustomdrawSlider1)
END_MESSAGE_MAP()
...
BOOL CTankDlg::OnInitDialog()
{
	...
	p1.SubclassDlgItem(IDC_TANK, this);
...
void CTankDlg::OnNMCustomdrawSlider1(NMHDR *pNMHDR, LRESULT *pResult)
{
