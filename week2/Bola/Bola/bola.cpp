...
CMiVentana::CMiVentana(char *name)
{
	...
	miBoton.Create("Salir",WS_CHILD|WS_VISIBLE|BS_PUSHBUTTON,
									CRect(0,0,80,40),this,1001);
										 //x1, y1, x2, y2

	tim1.Create("Start",WS_CHILD|WS_VISIBLE|BS_PUSHBUTTON,
									CRect(0,50,80,90),this,1002);

	tim2.Create("Stop",WS_CHILD|WS_VISIBLE|BS_PUSHBUTTON,
									CRect(0,100,80,140),this,1003);
...
{
	SetTimer(1,100,NULL); // 1:ID, 100 son ms
